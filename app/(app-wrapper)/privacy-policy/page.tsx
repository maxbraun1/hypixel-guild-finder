...
export default function PrivacyPolicy() {
  return (
    <div className="privacy-policy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hypixel Guild Finder.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Hypixel Guild Finder, accessible
            from{" "}
            <a
              href="https://hypixelguildfinder.com"
      ...
      <ul>
        <li>By email: info@hypixelguildfinder.com</li>
      </ul>
    </div>
  );
}
